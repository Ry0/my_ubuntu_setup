...
cd /tmp
# if [ ! -f OpenCV-2.4.8.tar.bz2 ]; then 
#     wget http://sourceforge.net/projects/opencvlibrary/files/opencv-unix/2.4.5/OpenCV-2.4.5.tar.bz2
# fi 
wget https://github.com/Itseez/opencv/archive/2.4.9.tar.gz
mv 2.4.9.tar.gz OpenCV-2.4.9.tar.gz

sudo rm -rf OpenCV-2.4.9
tar -xvzof /tmp/OpenCV-2.4.9.tar.gz
cd opencv-2.4.9
